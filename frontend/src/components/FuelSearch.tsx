            ...
            <div className="relative flex-1 max-w-xl">
              ...
              <input
                ...
                className="
                  ...
                  text-sm
                  outline-none
                  focus:bg-card focus:border-primary/25
                  disabled:opacity-50
                "
              />
            </div>
          ...
          <div className="flex items-center gap-2 shrink-0">
            ...
            <div className="relative" ref={fuelDropdownRef}>
              <button
                ...
                className="h-11 px-3 rounded-lg flex items-center gap-1.5 text-sm text-muted-foreground border py-1.5 hover:bg-muted transition-colors active:scale-[0.97]"
              >
                  ...
                  {FUEL_OPTIONS.map(({ id, label, icon: Icon, color, activeBg }) => {
                    ...
                    return (
                      <button
                        ...
                        className={`
                          flex items-center gap-1.5 text-sm text-muted-foreground border rounded-lg px-3 py-1.5 hover:bg-muted transition-colors active:scale-[0.97] w-full
                          ${active ? activeBg : ""}
                        `}
                      >
            ...
            <button
              type="button"
              onClick={handleClear}
              className="h-11 w-11 rounded-lg text-muted-foreground hover:text-foreground hover:bg-muted transition-colors flex items-center justify-center"
            >
              <X className="w-5 h-5" />
            </button>
          </div>
          ...
          {FUEL_OPTIONS.map(({ id, label, icon: Icon, color, activeBg }) => {
            ...
            return (
              <button
                ...
                onClick={() => toggleFuel(id)}
                className={`
                  flex items-center gap-1.5 text-sm text-muted-foreground border rounded-lg px-3 py-1.5 hover:bg-muted transition-colors active:scale-[0.97]
                  ${active ? activeBg : ""}
                `}
              >
                <Icon className={`w-3.5 h-3.5 ${active ? color : ""}`} />
