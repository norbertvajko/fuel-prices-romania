...
const CityAverages = ({ city, stations, isLoading, lastUpdated, headerRef }: CityAveragesProps & { headerRef?: React.RefObject<HTMLDivElement | null> }) => {
    ...
    return (
        <div className="rounded-xl bg-card border shadow-sm overflow-hidden animate-fade-in-up">
            {/* Header strip */}
            <div ref={headerRef} className="bg-primary px-3 sm:px-5 py-2.5 sm:py-3 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2 sm:gap-0">
